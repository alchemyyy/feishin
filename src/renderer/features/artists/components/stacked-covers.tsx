...
class SpunStackTheme extends StackTheme {
    ...
    render(): React.ReactNode {
        ...
        return (
            <div className={clsx(styles.stackedContainer, this.className)}>
                {reversedAlbums.map((album, index) => {
                    ...
                    return (
                        <div
                            className={clsx(styles.albumCover, styles.spunCover, {
                                [styles.isRound]: this.isRound,
                            })}
        ...
        return (
            <div className={clsx(styles.stackedContainer, this.className)}>
                {reversedAlbums.map((album, index) => {
                    ...
                    return (
                        <div
                            className={clsx(styles.albumCover, styles.staggeredCover, {
                                [styles.isRound]: this.isRound,
                            })}
                            key={`${album.albumId}-${index}`}
                            style={{
...
export const getArtistImageDisplay = (
    ...
    settings: {
        ...
        artistCoverStackStyleSettings: Record<
...
export const StackedCovers = ({
    ...
    const albums: AlbumCoverData[] = albumIds.map((albumId) => ({
        albumId,
        imageUrl: api.controller.getImageUrl({
